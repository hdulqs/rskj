...
public class BlockChainBuilder {
    ...
    public BlockChainImpl build(boolean withoutCleaner) {
        ...
        BlockChainImpl blockChain = new BlockChainImpl(this.repository, this.blockStore, receiptStore, transactionPool, listener, this.adminInfo, blockValidator, new BlockExecutor(config, this.repository, receiptStore, this.blockStore, listener));
