...
public class TestRunner {
    ...
    public List<String> runTestCase(BlockTestCase testCase) {
        ...
        BlockChainImpl blockchain = new BlockChainImpl(repository, blockStore, receiptStore, transactionPool, null, null, new DummyBlockValidator(), new BlockExecutor(config, repository, receiptStore, blockStore, null));
